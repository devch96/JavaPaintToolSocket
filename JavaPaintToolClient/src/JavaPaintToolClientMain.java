...
public class JavaPaintToolClientMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JavaPaintToolClientMain frame = new JavaPaintToolClientMain();
	 ...
	 * Create the frame.
	 */
	public JavaPaintToolClientMain() {
	...
	class Myaction implements ActionListener // 내부클래스로 액션 이벤트 처리 클래스
	{
		...
		public void actionPerformed(ActionEvent e) {
			...
			JavaPaintToolClientView view = new JavaPaintToolClientView(username, ip_addr, port_no);
			setVisible(false);
		}
	}
}
